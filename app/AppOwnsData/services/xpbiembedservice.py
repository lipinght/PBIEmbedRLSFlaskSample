...
from app.AppOwnsData.services.aadservice import AadService
from app.AppOwnsData.models.reportconfig import ReportConfig
from app.AppOwnsData.models.embedtoken import EmbedToken
from app.AppOwnsData.models.embedconfig import EmbedConfig
from app.AppOwnsData.models.embedtokenrequestbody import EmbedTokenRequestBody
...
class PbiEmbedService:
    ...
    def RLS(self, workspace_id, report_id, username_id, role_id, additional_dataset_id=None):
        ...
        embed_token = self.get_embed_token_for_single_report_single_workspaceRLS(report_id, dataset_ids, username_id, role_id, workspace_id)
